...
function StatsSection() {
    const stats = [
        { icon: <People size={40} />, count: "25,000+", label: "Youth Members" },
        { icon: <Building size={40} />, count: "170", label: "Parish Units" },
        { icon: <Globe size={40} />, count: "12", label: "Forane Committees" },
        { icon: <Award size={40} />, count: "50+", label: "Years of Service" },
    ];

    return (
        <div className="section-padding" style={{ backgroundColor: '#E14B1F', color: 'white' }}>
            <Container>
