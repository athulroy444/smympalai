...
const styles = {
    ...
    topBar: { width: '60px', height: '4px', backgroundColor: '#E14B1F', margin: '0 auto 20px' },
    mainTitle: { fontSize: 'clamp(2rem, 5vw, 3.5rem)', fontWeight: '800', fontFamily: "'Outfit', sans-serif", color: '#1e293b', letterSpacing: '-0.02em', marginBottom: '15px' },
    subTitleBox: {
        marginTop: '10px',
        padding: '8px 20px',
        ...
        border: '1px solid rgba(225, 75, 31, 0.2)'
    },
    subTitle: { fontSize: '0.9rem', color: '#E14B1F', fontWeight: '800', letterSpacing: '2px', textTransform: 'uppercase' },
    ...
    glassLine: {
        ...
        width: '0%',
        height: '4px',
        background: 'linear-gradient(to right, #E14B1F, #ff6a3d)',
